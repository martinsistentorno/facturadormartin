...
export default async function handler(req, res) {
  ...
  try {
    ...
    if (baseStatus.tests.homologacion.includes("EXITO") && baseStatus.tests.produccion.includes("FALLO")) {
      baseStatus.tests.conclusion = "CERTIFICADO DE HOMOLOGACI├ôN DETECTADO. No pod├®s emitir facturas reales con este certificado."
    } else if (baseStatus.tests.produccion.includes("EXITO")) {
      baseStatus.tests.conclusion = "CERTIFICADO DE PRODUCCI├ôN DETECTADO. Todo listo para emitir facturas legales."
    }

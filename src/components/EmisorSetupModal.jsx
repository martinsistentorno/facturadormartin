...
export default function EmisorSetupModal({ isOpen, onClose, onSave, currentData, isFirstSetup }) {
  ...
  const handleSubmit = async (e) => {
    ...
    if (!form.razon_social.trim()) return setError('La Raz�n Social es obligatoria')
    if (form.cuit.length !== 11) return setError('El CUIT debe tener 11 d�gitos')
      ...
      >
          ...
          <div className="overflow-y-auto px-6 py-4 scrollbar-hide">
            <form id="emisor-form" onSubmit={handleSubmit} className="space-y-4">
              ...
              {/* Raz�n Social & CUIT (Compacto a 2 columnas) */}
              <div className="grid grid-cols-5 gap-3">
                <div className="col-span-3">
                  <MinimalField 
                    label="Raz�n Social" icon={Building2} full
              ...
              {/* Facturaci�n (3 columnas compactas) */}
              <div className="grid grid-cols-12 gap-3 items-end">
                <div className="col-span-5">
                  <MinimalField 
                    label="Condici�n IVA" icon={Receipt} isSelect full
